...
public class IjkVideoView extends FrameLayout implements MediaController.MediaPlayerControl {
    ...
    private void openVideo() {
        ...
        try {
            ...
            mMediaPlayer.setOnMetaChangeListener(mOnMetaChangeListener);
...
//    }
    ...
    private IMediaPlayer.OnMetaChangeListener onMetaChangeListener;

    public void setOnMetaChangeListener(IMediaPlayer.OnMetaChangeListener listener){
        this.onMetaChangeListener = listener;
    }

    private IMediaPlayer.OnMetaChangeListener mOnMetaChangeListener = new IMediaPlayer.OnMetaChangeListener() {
        @Override
        public void onChanged(IMediaPlayer mp, long meta) {
            if(onMetaChangeListener!=null) {
                onMetaChangeListener.onChanged(mp,meta);
            }
        }
    };
}
