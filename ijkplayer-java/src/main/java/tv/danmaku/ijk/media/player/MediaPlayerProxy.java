...
public class MediaPlayerProxy implements IMediaPlayer {
    ...
    @Override
    public void setOnMetaChangeListener(OnMetaChangeListener listener) {
        if (listener != null) {
            final OnMetaChangeListener finalListener = listener;
            mBackEndMediaPlayer.setOnMetaChangeListener(new OnMetaChangeListener() {
                @Override
                public void onChanged(IMediaPlayer mp, long meta) {
                    finalListener.onChanged(mp, meta);
                }
            });
        } else {
            mBackEndMediaPlayer.setOnMetaChangeListener(null);
        }
    }
