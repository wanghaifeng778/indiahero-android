...
public abstract class AbstractMediaPlayer implements IMediaPlayer {
    ...
    private OnMetaChangeListener mOnMetaChangeListener;
    ...
    @Override
    public final void setOnMetaChangeListener(OnMetaChangeListener listener) {
        mOnMetaChangeListener = listener;
    }
    ...
    protected final void notifyOnMetaChanged(long mills) {
        if (mOnMetaChangeListener != null)
            mOnMetaChangeListener.onChanged(this, mills);
    }
}
